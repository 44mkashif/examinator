                    ...
                    <Grid item md={8} >
                        <div>
                            ...
                            <Typography variant="body1" gutterBottom>
                                ...
                                <h3 align='left' className={classes.olHeading}>During the exam</h3>
                                <ol >
                                ...
                                <h3 align='left' className={classes.olHeading}> Instructions for accessing the Exam</h3>
                                <ol >
                                ...
                                <h4 align='left' className={classes.olHeading}>Click the &ldquo;Submit&rdquo; button in the bottom right corner when you are done submitting your work.</h4>

                                <p className={classes.olHeading}>Your exam, you must contact your instructor immediately by phone. Jennifer Lewis can be reached at 03017344555.</p>
                                <p className={classes.olHeading}>If she does not hear from you right away, your exam may not be accepted, and you may receive a zero on the exam.</p>
                        ...
                        <Grid container align="center" justify="center" className={classes.margin}>
                            <Button className={classes.button}
                                variant="contained"
                                color="primary"
                                // component={Link} to={`./Exam/:${examRoom}`}
                                onClick={event => { navigateTo(`../../facedetect`) }}
